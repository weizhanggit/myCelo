...
var (
	...
	//proxyOwnerStorageLocation = common.HexToHash("0x0b43fc4bbd4bf98f71ce81c667b087932f6d9ae32839082ef4b7ef189c48f7de")
	...
	//proxyByteCode             = common.Hex2Bytes("")
...
func newDeployment(genesisConfig *Config, accounts *env.AccountsConfig, buildPath string) *deployContext {
	...
	return &deployContext{
		...
		logger:        logger,
		statedb:       statedb,
		truffleReader: contract.NewTruffleReader(buildPath), //truffleReader buildPath 得是一个完整的truffle地址
		runtimeConfig: &runtime.Config{
...
func (ctx *deployContext) deploy() (core.GenesisAlloc, error) {
	...
	deploySteps := [](func() error){
		...
		// 08 ReserveSpenderMultisig (requires reserve to work) （需要保留才能工作）
	...
	fmt.Println("ctx.contract(\"Registry\").Address", ctx.contract("Registry").Address.String())
	var add common.Address
	ctx.contract("Registry").Query(&add, "getAddressFor", params.ElectionRegistryId)
	fmt.Println("Query:", add.String())
	var newValSet []common.Address
	ctx.contract("Election").Query(&newValSet, "electValidatorSigners")
	fmt.Println("newValSet:", newValSet)
...
// 它将部署代理契约和impl契约，并初始化两者
// implAddress-> proxy: _setImplementation
// proxyAddress-> proxyByteCode
// 代理合约 设置 目标合约
func (ctx *deployContext) deployProxiedContract(name string, initialize func(contract *contract.EVMBackend) error) error {
	...
	ctx.statedb.SetCode(proxyAddress, proxyByteCode)                                       //proxyAddress 设置代理bytecode 全部一样也可以 地址不同就好
...
func (ctx *deployContext) deployCoreContract(name string, initialize func(contract *contract.EVMBackend) error) error {
	...
	// Registry setAddressFor -> common.Address 部署的时候用common.Address 存的都是代理hash
...
func (ctx *deployContext) deployStableTokens() error {
	...
	for _, token := range tokens {
		...
		if token.cfg.GoldPrice != nil {
			...
			// first check if the Admin_my is an authorized oracle
			authorized := false
			for _, oracleAddress := range token.cfg.Oracles {
			...
			if !authorized {
				ctx.logger.Warn("Fixing StableToken goldprice requires setting Admin_my as oracle", "Admin_my", ctx.accounts.AdminAccount().Address)
...
func (ctx *deployContext) registerValidators() error {
	...
	for _, validator := range validatorAccounts {
		...
		//err = Validators_my.SimpleCallFrom(address, "registerValidator", pubKey, blsPub[:], validator.MustBLSProofOfPossession())
		err := validators.SimpleCallFrom(address, "registerValidator")
		if err != nil {
			return err
		}
	}
...
func (ctx *deployContext) addValidatorsToGroups() error {
	...
	for groupIdx, group := range validatorGroups {
		...
		for i, validator := range group.Validators {
			...
			// affiliate Validators_my to group
...
func (ctx *deployContext) electValidators() error {
	...
	// TODO: Config checks
	// check that we have enough Validators_my (Validators_my >= election.minElectableValidators)
